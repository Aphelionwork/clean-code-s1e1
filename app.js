...
const createNewTaskElement = function(taskString) {
  ...
  listItem.classList.add("section__list-row");
  ...
  label.classList.add("input__task", "input__task-label");
  //input (text)
  const editInput = document.createElement("input"); //text
  editInput.classList.add("input__task", "input_text"); 
  //button.edit
...
const editTask = function() {
  ...
  const label = listItem.querySelector(".input__task-label");
